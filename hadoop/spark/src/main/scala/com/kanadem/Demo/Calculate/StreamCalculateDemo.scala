...
object StreamCalculateDemo {
  def main(args: Array[String]): Unit = {
    ...
    val topic = args(0)
    val zkQuorum = "192.168.1.101:2181"
    val topics: Set[String] = Set(topic)
    val brokerList = "192.168.1.101:9092"
    ...
    kafkaStream.foreachRDD { kafkaRDD =>
      ...
      //CalculateUtil.calculateOrderAmount(fields)
      CalculateUtil.calculateMessageTypeAmount(lines)


//      lines.foreachPartition(partition =>
//        partition.foreach(x => {
//          val xml: Array[String] = x.split(" ")
//          if (xml.length >= 3){
//            val xmlType = xml(2).split("ceb:")
//            println(xmlType(1))
//          }
//        })
//      )
